										...
										<article className={`order-details ${ item.index === 1 ? '' : 'none' }`}>
											<div className="order-details__row">
												...
												<div className="info-row">
													...
													<em className="pull-left">{ detailData.createdTime ? moment(detailData.createdTime).format(dateFormat) : '' }</em>
											...
											<div className="order-details__row">
												<div className="pull-left order-details__row-group">
													...
													<div className="info-row">
														...
														<em className="pull-left">{ detailData.prePayTime ? 
															moment(detailData.prePayTime).format(format) : '' }</em>
														<div className="clear"></div>
													</div>

													<div className="info-row">
														<span className="pull-left">实支付日期：</span>
														<em className="pull-left">{ detailData.realPayTime ? moment(detailData.realPayTime).format(dateFormat) : '' }</em>
														<div className="clear"></div>
													</div>
												</div>
