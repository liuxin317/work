...
export default class ListDetails extends Component {
	...
	getProcessLog = () => {
      ...
      processInstId: rowData ? rowData.processInstId : 0,
			orderId: this.props.source ? detailData.orderId : detailData.id // 工作台和日常详情合并差异
		}, res => {
			let processLogData = [];
			let data = res.data;
			let names = [];
	...
	render() { 
		const { detailData, source } = this.props;
		...
		if (this.props.source) { // 工作台和日常详情合并差异
			acAccount = detailData.acAccount ? detailData.acAccount : {};
		}
									...
									<article className={`order-details ${ item.index === 1 ? '' : 'none' }`}>
										<div className="order-details__row">
											...
											<div className="info-row">
												...
												<em className="pull-left">{ source ? detailData.createdTime ? moment(detailData.createdTime).format('YYYY-MM-DD') : '' : detailData.createdTime }</em>
											...
											{detailData.sourceCode==1?
												...
												<div className="info-row">
													...
													<em className="pull-left">{detailData.thirdOrderCode}</em>
													<div className="clear"></div>
												</div>
											}
											...
											<div className="info-row">
												...
												<em className="pull-left">{ detailData.busTypeName }</em>
												<div className="clear"></div>
											</div>
										</div>
										...
										<div className="order-details__row">
											<div className="pull-left order-details__row-group">
												...
												<div className="info-row">
													...
													<em className="pull-left">{ acAccount.accountName }</em>
													<div className="clear"></div>
												</div>
										...
										<div className="order-details__row">
											...
											<div className="pull-left order-details__row-group">
												...
												<div className="info-row">
													<span className="pull-left">金额：</span>
													<em className="pull-left">{ detailData.amount }</em>
													<div className="clear"></div>
												</div>
											</div>
										...
										<div className="order-details__row">
											<div className="pull-left order-details__row-group">
												...
												<div className="info-row">
													...
													<em className="pull-left">{ source ? detailData.prePayTime ? moment(detailData.prePayTime).format('YYYY-MM-DD') : '' : detailData.prePayTime }</em>
													<div className="clear"></div>
												</div>

												<div className="info-row">
													<span className="pull-left">实支付日期：</span>
													<em className="pull-left">{ source ? detailData.realPayTime ? moment(detailData.realPayTime).format('YYYY-MM-DD') : '' : detailData.realPayTime }</em>
													<div className="clear"></div>
												</div>
											</div>

											<div className="pull-left order-details__row-group">
												<h4 className="details-title">订单状态：</h4>

												<div className="info-row">
													<span className="pull-left">订单状态：</span>
													<em className="pull-left">
